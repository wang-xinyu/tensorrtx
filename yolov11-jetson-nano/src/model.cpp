...
nvinfer1::IHostMemory* buildEngineYolo11Cls(nvinfer1::IBuilder* builder, nvinfer1::IBuilderConfig* config,
    ...
    // this code was changed to support TensorRT7
    ...
    // No olvides liberar el engine después:
    engine->destroy();
...
nvinfer1::IHostMemory* buildEngineYolo11Det(nvinfer1::IBuilder* builder, nvinfer1::IBuilderConfig* config,
    ...
    *******************************************************************************************************/
    ...
    upsample11->setResizeMode(nvinfer1::ResizeMode(0));
    ...
    assert(upsample14);
    upsample14->setResizeMode(nvinfer1::ResizeMode(0));
