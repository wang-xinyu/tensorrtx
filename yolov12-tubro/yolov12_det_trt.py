...
class warmUpThread(threading.Thread):
    ...
    def run(self):
        batch_image_raw, use_time = self.yolov12_wrapper.infer(self.yolov12_wrapper.get_raw_image_zeros())
        print('warm_up->{}, time->{:.2f}ms'.format(batch_image_raw[0].shape, use_time * 1000))


if __name__ == "__main__":
    # load custom plugin and engine
    PLUGIN_LIBRARY = "E:\\tensorrtx-master\\yolov12\\build\\Debug\\myplugins.dll"
    engine_file_path = "E:\\tensorrtx-master\\yolov12\\build\\Debug\\yolov12n-det-1.engine"
    ...
    try:
        ...
        image_dir = "E:\\tensorrtx-master\\yolov12\images"
