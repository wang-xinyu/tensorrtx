...
int main(int argc, char** argv) {
    ...
    if (!parse_args(argc, argv, wts_name, engine_name, img_dir, type, cuda_post_process, labels_filename, gd, gw,
        ...
        std::cerr << "./yolov12-seg -s [.wts] [.engine] [n/s/m/l/x]  // serialize model to plan file" << std::endl;
        std::cerr << "./yolov12-seg -d [.engine] ../images  [c/g] coco_file// deserialize plan file and run inference"
                  << std::endl;
        return -1;
    }
