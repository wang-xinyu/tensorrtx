...
class YoLov8TRT(object):
    ...
    def infer(self, raw_image_generator):
        ...
        for i in range(self.batch_size):
            result_boxes, result_scores, result_classid, result_proto_coef = self.post_process(
                output[i * self.det_output_length: (i + 1) * self.det_output_length], batch_origin_h[i], batch_origin_w[i]
            )
    ...
    def post_process(self, output, origin_h, origin_w):
        ...
        return:
            ...
            result_proto_coef: finally proto coefficient
        """
    ...
    def non_max_suppression(self, prediction, origin_h, origin_w, conf_thres=0.5, nms_thres=0.4):
        ...
        return:
            boxes: output after nms with the shape (x1, y1, x2, y2, conf, cls_id, mask coefficients)
        """
