...
nvinfer1::IHostMemory* buildEngineYolov8_5uDet(nvinfer1::IBuilder* builder, nvinfer1::IBuilderConfig* config,
    ...
    *******************************************************************************************************/
    ...
    nvinfer1::IElementWiseLayer* conv0 = convBnSiLU(network, weightMap, *data, get_width_5u(64, gw), 6, 2, calculateP(6), "model.0");
    nvinfer1::IElementWiseLayer* conv1 = convBnSiLU(network, weightMap, *conv0->getOutput(0), get_width_5u(128, gw), 3, 2, calculateP(3), "model.1");
    // 11233
    nvinfer1::IElementWiseLayer* conv2 = C3(network, weightMap, *conv1->getOutput(0), get_width_5u(128, gw), get_width_5u(128, gw), get_depth(3, gd), true, 0.5, "model.2");



    nvinfer1::IElementWiseLayer* conv3 = convBnSiLU(network, weightMap, *conv2->getOutput(0), get_width_5u(256, gw), 3, 2, calculateP(3), "model.3");
    // 22466
    nvinfer1::IElementWiseLayer* conv4 = C3(network, weightMap, *conv3->getOutput(0), get_width_5u(256, gw), get_width_5u(256, gw), get_depth(6, gd), true, 0.5, "model.4");
    nvinfer1::IElementWiseLayer* conv5 = convBnSiLU(network, weightMap, *conv4->getOutput(0), get_width_5u(512, gw), 3, 2, calculateP(3), "model.5");
    // 22466
    nvinfer1::IElementWiseLayer* conv6 = C3(network, weightMap, *conv5->getOutput(0), get_width_5u(512, gw), get_width_5u(512, gw), get_depth(6, gd), true, 0.5, "model.6");
    nvinfer1::IElementWiseLayer* conv7 = convBnSiLU(network, weightMap, *conv6->getOutput(0), get_width_5u(1024, gw), 3, 2, calculateP(3), "model.7");
    // 11233
    nvinfer1::IElementWiseLayer* conv8 = C3(network, weightMap, *conv7->getOutput(0), get_width_5u(1024, gw), get_width_5u(1024, gw), get_depth(3, gd), true, 0.5, "model.8");
    nvinfer1::IElementWiseLayer* conv9 = SPPF(network, weightMap, *conv8->getOutput(0), get_width_5u(1024, gw), get_width_5u(1024, gw), 5, "model.9");
    /*******************************************************************************************************
    *********************************************  YOLOV5U HEAD  ********************************************
    *******************************************************************************************************/

    //    auto conv10 = convBlock(network, weightMap, *spp9->getOutput(0), get_width_5u(512, gw), 1, 1, 1, "model.10");

    //*********************************************  cat backbone P4   ********************************************
    nvinfer1::IElementWiseLayer* conv10 = convBnSiLU(network, weightMap, *conv9->getOutput(0), get_width_5u(512, gw), 1, 1, calculateP(1), "model.10");
    ...
    nvinfer1::IElementWiseLayer* conv13 = C3(network, weightMap, *cat12->getOutput(0), get_width_5u(512, gw), get_width_5u(512, gw), get_depth(3, gd), false, 0.5, "model.13");
    //*********************************************  cat backbone P4   ********************************************



    //*********************************************  cat backbone P3   ********************************************
    nvinfer1::IElementWiseLayer* conv14 = convBnSiLU(network, weightMap, *conv13->getOutput(0), get_width_5u(256, gw), 1, 1, calculateP(1), "model.14");
    nvinfer1::IResizeLayer* upsample15 = network->addResize(*conv14->getOutput(0));
    assert(upsample15);
    upsample15->setResizeMode(nvinfer1::ResizeMode::kNEAREST);
    ...
    nvinfer1::IElementWiseLayer* conv17 = C3(network, weightMap, *cat16->getOutput(0), get_width_5u(256, gw), get_width_5u(256, gw), get_depth(3, gd), false, 0.5, "model.17");
    //*********************************************  cat backbone P3   ********************************************
    ...
    //*********************************************  cat head P4   ********************************************
    nvinfer1::IElementWiseLayer* conv18 = convBnSiLU(network, weightMap, *conv17->getOutput(0), get_width_5u(256, gw), 3, 2, calculateP(3), "model.18");
    ...
    nvinfer1::IElementWiseLayer* conv20 = C3(network, weightMap, *cat19->getOutput(0), get_width_5u(512, gw), get_width_5u(512, gw), get_depth(3, gd), false, 0.5, "model.20");
    //*********************************************  cat head P4   ********************************************



    //*********************************************  cat head P3   ********************************************
    nvinfer1::IElementWiseLayer* conv21 = convBnSiLU(network, weightMap, *conv20->getOutput(0), get_width_5u(512, gw), 3, 2, calculateP(3), "model.21");
    ...
    nvinfer1::IElementWiseLayer* conv23 = C3(network, weightMap, *cat22->getOutput(0), get_width_5u(1024, gw), get_width_5u(1024, gw), get_depth(3, gd), false, 0.5, "model.23");
    //*********************************************  cat head P3   ********************************************
    ...
    *******************************************************************************************************/
    ...
    // output0
    nvinfer1::IElementWiseLayer* conv24_cv2_0_0 = convBnSiLU(network, weightMap, *conv17->getOutput(0), base_in_channel, 3, 1, calculateP(3), "model.24.cv2.0.0");
    nvinfer1::IElementWiseLayer* conv24_cv2_0_1 = convBnSiLU(network, weightMap, *conv24_cv2_0_0->getOutput(0), base_in_channel, 3, 1, calculateP(3), "model.24.cv2.0.1");
    nvinfer1::IConvolutionLayer* conv24_cv2_0_2 = network->addConvolutionNd(*conv24_cv2_0_1->getOutput(0), 64, nvinfer1::DimsHW{1, 1}, weightMap["model.24.cv2.0.2.weight"], weightMap["model.24.cv2.0.2.bias"]);
    conv24_cv2_0_2->setStrideNd(nvinfer1::DimsHW{1, 1});
    conv24_cv2_0_2->setPaddingNd(nvinfer1::DimsHW{0, 0});
    nvinfer1::IElementWiseLayer* conv24_cv3_0_0 = convBnSiLU(network, weightMap, *conv17->getOutput(0), base_out_channel, 3, 1, calculateP(3), "model.24.cv3.0.0");
    nvinfer1::IElementWiseLayer* conv24_cv3_0_1 = convBnSiLU(network, weightMap, *conv24_cv3_0_0->getOutput(0), base_out_channel, 3, 1, calculateP(3), "model.24.cv3.0.1");
    nvinfer1::IConvolutionLayer* conv24_cv3_0_2 = network->addConvolutionNd(*conv24_cv3_0_1->getOutput(0), kNumClass, nvinfer1::DimsHW{1, 1}, weightMap["model.24.cv3.0.2.weight"], weightMap["model.24.cv3.0.2.bias"]);
    ...
    // output1
    nvinfer1::IElementWiseLayer* conv24_cv2_1_0 = convBnSiLU(network, weightMap, *conv20->getOutput(0), base_in_channel, 3, 1, calculateP(3), "model.24.cv2.1.0");
    nvinfer1::IElementWiseLayer* conv24_cv2_1_1 = convBnSiLU(network, weightMap, *conv24_cv2_1_0->getOutput(0), base_in_channel, 3, 1, calculateP(3), "model.24.cv2.1.1");
    nvinfer1::IConvolutionLayer* conv24_cv2_1_2 = network->addConvolutionNd(*conv24_cv2_1_1->getOutput(0), 64, nvinfer1::DimsHW{1, 1}, weightMap["model.24.cv2.1.2.weight"], weightMap["model.24.cv2.1.2.bias"]);
    conv24_cv2_1_2->setStrideNd(nvinfer1::DimsHW{1, 1});
    conv24_cv2_1_2->setPaddingNd(nvinfer1::DimsHW{0, 0});
    nvinfer1::IElementWiseLayer* conv24_cv3_1_0 = convBnSiLU(network, weightMap, *conv20->getOutput(0), base_out_channel, 3, 1, calculateP(3), "model.24.cv3.1.0");
    nvinfer1::IElementWiseLayer* conv24_cv3_1_1 = convBnSiLU(network, weightMap, *conv24_cv3_1_0->getOutput(0), base_out_channel, 3, 1, calculateP(3), "model.24.cv3.1.1");
    nvinfer1::IConvolutionLayer* conv24_cv3_1_2 = network->addConvolutionNd(*conv24_cv3_1_1->getOutput(0), kNumClass, nvinfer1::DimsHW{1, 1}, weightMap["model.24.cv3.1.2.weight"], weightMap["model.24.cv3.1.2.bias"]);
    ...
    // output2
    nvinfer1::IElementWiseLayer* conv24_cv2_2_0 = convBnSiLU(network, weightMap, *conv23->getOutput(0), base_in_channel, 3, 1, calculateP(3), "model.24.cv2.2.0");
    nvinfer1::IElementWiseLayer* conv24_cv2_2_1 = convBnSiLU(network, weightMap, *conv24_cv2_2_0->getOutput(0), base_in_channel, 3, 1, calculateP(3), "model.24.cv2.2.1");
    nvinfer1::IConvolutionLayer* conv24_cv2_2_2 = network->addConvolutionNd(*conv24_cv2_2_1->getOutput(0), 64, nvinfer1::DimsHW{1, 1}, weightMap["model.24.cv2.2.2.weight"], weightMap["model.24.cv2.2.2.bias"]);
    conv24_cv2_2_2->setStrideNd(nvinfer1::DimsHW{1, 1});
    conv24_cv2_2_2->setPaddingNd(nvinfer1::DimsHW{0, 0});
    nvinfer1::IElementWiseLayer* conv24_cv3_2_0 = convBnSiLU(network, weightMap, *conv23->getOutput(0), base_out_channel, 3, 1, calculateP(3), "model.24.cv3.2.0");
    nvinfer1::IElementWiseLayer* conv24_cv3_2_1 = convBnSiLU(network, weightMap, *conv24_cv3_2_0->getOutput(0), base_out_channel, 3, 1, calculateP(3), "model.24.cv3.2.1");
    nvinfer1::IConvolutionLayer* conv24_cv3_2_2 = network->addConvolutionNd(*conv24_cv3_2_1->getOutput(0), kNumClass, nvinfer1::DimsHW{1, 1}, weightMap["model.24.cv3.2.2.weight"], weightMap["model.24.cv3.2.2.bias"]);
    ...
    *******************************************************************************************************/
    ...
    nvinfer1::ISliceLayer* split24_0_0 = network->addSlice( *shuffle24_0->getOutput(0), nvinfer1::Dims2{0, 0}, nvinfer1::Dims2{64, (kInputH / strides[0]) * (kInputW / strides[0])}, nvinfer1::Dims2{1, 1});
    nvinfer1::ISliceLayer* split24_0_1 = network->addSlice( *shuffle24_0->getOutput(0), nvinfer1::Dims2{64, 0}, nvinfer1::Dims2{kNumClass, (kInputH / strides[0]) * (kInputW / strides[0])}, nvinfer1::Dims2{1, 1});
    nvinfer1::IShuffleLayer* dfl24_0 = DFL(network, weightMap, *split24_0_0->getOutput(0), 4, (kInputH / strides[0]) * (kInputW / strides[0]), 1, 1, 0, "model.24.dfl.conv.weight");
    ...
    nvinfer1::ISliceLayer* split24_2_0 = network->addSlice( *shuffle24_2->getOutput(0), nvinfer1::Dims2{0, 0}, nvinfer1::Dims2{64, (kInputH / strides[2]) * (kInputW / strides[2])}, nvinfer1::Dims2{1, 1});
    nvinfer1::ISliceLayer* split24_2_1 = network->addSlice( *shuffle24_2->getOutput(0), nvinfer1::Dims2{64, 0}, nvinfer1::Dims2{kNumClass, (kInputH / strides[2]) * (kInputW / strides[2])}, nvinfer1::Dims2{1, 1});
    nvinfer1::IShuffleLayer* dfl24_2 = DFL(network, weightMap, *split24_2_0->getOutput(0), 4, (kInputH / strides[2]) * (kInputW / strides[2]), 1, 1, 0, "model.24.dfl.conv.weight");
    ...
    nvinfer1::IPluginV2Layer* yolo = addYoLoLayer(network, std::vector<nvinfer1::IConcatenationLayer*>{cat24_dfl_0, cat24_dfl_1, cat24_dfl_2}, strides, stridesLength, false, false);
...
nvinfer1::IHostMemory* buildEngineYolov8_5uDetP6(nvinfer1::IBuilder* builder, nvinfer1::IBuilderConfig* config,
    ...
    *******************************************************************************************************/
    ...
    // 22466
    nvinfer1::IElementWiseLayer* conv6 = C3(network, weightMap, *conv5->getOutput(0), get_width_5u(512, gw), get_width_5u(512, gw), get_depth(6, gd), true, 0.5, "model.6");
    nvinfer1::IElementWiseLayer* conv7 = convBnSiLU(network, weightMap, *conv6->getOutput(0), get_width_5u(768, gw), 3, 2, calculateP(3), "model.7");
    // 11233
    nvinfer1::IElementWiseLayer* conv8 = C3(network, weightMap, *conv7->getOutput(0), get_width_5u(768, gw), get_width_5u(768, gw), get_depth(3, gd), true, 0.5, "model.8");


    nvinfer1::IElementWiseLayer* conv9 = convBnSiLU(network, weightMap, *conv8->getOutput(0), get_width_5u(1024, gw), 3, 2, calculateP(3), "model.9");
    // 11233
    nvinfer1::IElementWiseLayer* conv10 = C3(network, weightMap, *conv9->getOutput(0), get_width_5u(1024, gw), get_width_5u(1024, gw), get_depth(3, gd), true, 0.5, "model.10");


    nvinfer1::IElementWiseLayer* conv11 = SPPF(network, weightMap, *conv10->getOutput(0), get_width_5u(1024, gw), get_width_5u(1024, gw), 5, "model.11");
    /*******************************************************************************************************
    *********************************************  YOLOV5U-P6 HEAD  ********************************************
    *******************************************************************************************************/
    ...
    //*********************************************  cat backbone P5   ********************************************
    nvinfer1::IElementWiseLayer* conv12 = convBnSiLU(network, weightMap, *conv11->getOutput(0), get_width_5u(768, gw), 1, 1, calculateP(1), "model.12");
    nvinfer1::IResizeLayer* upsample13 = network->addResize(*conv12->getOutput(0));
    assert(upsample13);
    upsample13->setResizeMode(nvinfer1::ResizeMode::kNEAREST);
    ...
    nvinfer1::IConcatenationLayer* cat14 = network->addConcatenation(inputTensor14, 2);
    nvinfer1::IElementWiseLayer* conv15 = C3(network, weightMap, *cat14->getOutput(0), get_width_5u(768, gw), get_width_5u(768, gw), get_depth(3, gd), false, 0.5, "model.15");
    //*********************************************  cat backbone P5   ********************************************



    //*********************************************  cat backbone P4   ********************************************
    nvinfer1::IElementWiseLayer* conv16 = convBnSiLU(network, weightMap, *conv15->getOutput(0), get_width_5u(512, gw), 1, 1, calculateP(1), "model.16");
    ...
    nvinfer1::IElementWiseLayer* conv19 = C3(network, weightMap, *cat18->getOutput(0), get_width_5u(512, gw), get_width_5u(512, gw), get_depth(3, gd), false, 0.5, "model.19");
    //*********************************************  cat backbone P4   ********************************************



    //*********************************************  cat backbone P3   ********************************************
    nvinfer1::IElementWiseLayer* conv20 = convBnSiLU(network, weightMap, *conv19->getOutput(0), get_width_5u(256, gw), 1, 1, calculateP(1), "model.20");
    ...
    nvinfer1::IConcatenationLayer* cat22 = network->addConcatenation(inputTensor22, 2);
    nvinfer1::IElementWiseLayer* conv23 = C3(network, weightMap, *cat22->getOutput(0), get_width_5u(256, gw), get_width_5u(256, gw), get_depth(3, gd), false, 0.5, "model.23");
    //*********************************************  cat backbone P3   ********************************************
    ...
    //*********************************************  cat head P4   ********************************************
    nvinfer1::IElementWiseLayer* conv24 = convBnSiLU(network, weightMap, *conv23->getOutput(0), get_width_5u(256, gw), 3, 2, calculateP(3), "model.24");
    ...
    nvinfer1::IElementWiseLayer* conv26 = C3(network, weightMap, *cat25->getOutput(0), get_width_5u(512, gw), get_width_5u(512, gw), get_depth(3, gd), false, 0.5, "model.26");
    //*********************************************  cat head P4   ********************************************



    //*********************************************  cat head P5   ********************************************
    nvinfer1::IElementWiseLayer* conv27 = convBnSiLU(network, weightMap, *conv26->getOutput(0), get_width_5u(512, gw), 3, 2, calculateP(3), "model.27");
    ...
    nvinfer1::IElementWiseLayer* conv29 = C3(network, weightMap, *cat28->getOutput(0), get_width_5u(768, gw), get_width_5u(768, gw), get_depth(3, gd), false, 0.5, "model.29");
    //*********************************************  cat head P5   ********************************************


    //*********************************************  cat head P6   ********************************************
    nvinfer1::IElementWiseLayer* conv30 = convBnSiLU(network, weightMap, *conv29->getOutput(0), get_width_5u(768, gw), 3, 2, calculateP(3), "model.30");
    ...
    nvinfer1::IElementWiseLayer* conv32 = C3(network, weightMap, *cat31->getOutput(0), get_width_5u(768, gw), get_width_5u(1024, gw), get_depth(3, gd), false, 0.5, "model.32");
    //*********************************************  cat head P6   ********************************************
    ...
    *******************************************************************************************************/
    ...
    // output0
    nvinfer1::IElementWiseLayer* conv33_cv2_0_0 = convBnSiLU(network, weightMap, *conv23->getOutput(0), base_in_channel, 3, 1, calculateP(3), "model.33.cv2.0.0");
    nvinfer1::IElementWiseLayer* conv33_cv2_0_1 = convBnSiLU(network, weightMap, *conv33_cv2_0_0->getOutput(0), base_in_channel, 3, 1, calculateP(3), "model.33.cv2.0.1");
    nvinfer1::IConvolutionLayer* conv33_cv2_0_2 = network->addConvolutionNd(*conv33_cv2_0_1->getOutput(0), 64, nvinfer1::DimsHW{1, 1}, weightMap["model.33.cv2.0.2.weight"], weightMap["model.33.cv2.0.2.bias"]);
    conv33_cv2_0_2->setStrideNd(nvinfer1::DimsHW{1, 1});
    conv33_cv2_0_2->setPaddingNd(nvinfer1::DimsHW{0, 0});
    nvinfer1::IElementWiseLayer* conv33_cv3_0_0 = convBnSiLU(network, weightMap, *conv23->getOutput(0), base_out_channel, 3, 1, calculateP(3), "model.33.cv3.0.0");
    nvinfer1::IElementWiseLayer* conv33_cv3_0_1 = convBnSiLU(network, weightMap, *conv33_cv3_0_0->getOutput(0), base_out_channel, 3, 1, calculateP(3), "model.33.cv3.0.1");
    nvinfer1::IConvolutionLayer* conv33_cv3_0_2 = network->addConvolutionNd(*conv33_cv3_0_1->getOutput(0), kNumClass, nvinfer1::DimsHW{1, 1}, weightMap["model.33.cv3.0.2.weight"], weightMap["model.33.cv3.0.2.bias"]);
    ...
    // output1
    nvinfer1::IElementWiseLayer* conv33_cv2_1_0 = convBnSiLU(network, weightMap, *conv26->getOutput(0), base_in_channel, 3, 1, calculateP(3), "model.33.cv2.1.0");
    nvinfer1::IElementWiseLayer* conv33_cv2_1_1 = convBnSiLU(network, weightMap, *conv33_cv2_1_0->getOutput(0), base_in_channel, 3, 1, calculateP(3), "model.33.cv2.1.1");
    nvinfer1::IConvolutionLayer* conv33_cv2_1_2 = network->addConvolutionNd(*conv33_cv2_1_1->getOutput(0), 64, nvinfer1::DimsHW{1, 1}, weightMap["model.33.cv2.1.2.weight"], weightMap["model.33.cv2.1.2.bias"]);
    conv33_cv2_1_2->setStrideNd(nvinfer1::DimsHW{1, 1});
    conv33_cv2_1_2->setPaddingNd(nvinfer1::DimsHW{0, 0});
    nvinfer1::IElementWiseLayer* conv33_cv3_1_0 = convBnSiLU(network, weightMap, *conv26->getOutput(0), base_out_channel, 3, 1, calculateP(3), "model.33.cv3.1.0");
    nvinfer1::IElementWiseLayer* conv33_cv3_1_1 = convBnSiLU(network, weightMap, *conv33_cv3_1_0->getOutput(0), base_out_channel, 3, 1, calculateP(3), "model.33.cv3.1.1");
    nvinfer1::IConvolutionLayer* conv33_cv3_1_2 = network->addConvolutionNd(*conv33_cv3_1_1->getOutput(0), kNumClass, nvinfer1::DimsHW{1, 1}, weightMap["model.33.cv3.1.2.weight"], weightMap["model.33.cv3.1.2.bias"]);
    ...
    // output2
    nvinfer1::IElementWiseLayer* conv33_cv2_2_0 = convBnSiLU(network, weightMap, *conv29->getOutput(0), base_in_channel, 3, 1, calculateP(3), "model.33.cv2.2.0");
    nvinfer1::IElementWiseLayer* conv33_cv2_2_1 = convBnSiLU(network, weightMap, *conv33_cv2_2_0->getOutput(0), base_in_channel, 3, 1, calculateP(3), "model.33.cv2.2.1");
    nvinfer1::IConvolutionLayer* conv33_cv2_2_2 = network->addConvolutionNd(*conv33_cv2_2_1->getOutput(0), 64, nvinfer1::DimsHW{1, 1}, weightMap["model.33.cv2.2.2.weight"], weightMap["model.33.cv2.2.2.bias"]);
    conv33_cv2_2_2->setStrideNd(nvinfer1::DimsHW{1, 1});
    conv33_cv2_2_2->setPaddingNd(nvinfer1::DimsHW{0, 0});
    nvinfer1::IElementWiseLayer* conv33_cv3_2_0 = convBnSiLU(network, weightMap, *conv29->getOutput(0), base_out_channel, 3, 1, calculateP(3), "model.33.cv3.2.0");
    nvinfer1::IElementWiseLayer* conv33_cv3_2_1 = convBnSiLU(network, weightMap, *conv33_cv3_2_0->getOutput(0), base_out_channel, 3, 1, calculateP(3), "model.33.cv3.2.1");
    nvinfer1::IConvolutionLayer* conv33_cv3_2_2 = network->addConvolutionNd(*conv33_cv3_2_1->getOutput(0), kNumClass, nvinfer1::DimsHW{1, 1}, weightMap["model.33.cv3.2.2.weight"], weightMap["model.33.cv3.2.2.bias"]);
    ...
    // output3
    nvinfer1::IElementWiseLayer* conv33_cv2_3_0 = convBnSiLU(network, weightMap, *conv32->getOutput(0), base_in_channel, 3, 1, calculateP(3), "model.33.cv2.3.0");
    nvinfer1::IElementWiseLayer* conv33_cv2_3_1 = convBnSiLU(network, weightMap, *conv33_cv2_3_0->getOutput(0), base_in_channel, 3, 1, calculateP(3), "model.33.cv2.3.1");
    nvinfer1::IConvolutionLayer* conv33_cv2_3_2 = network->addConvolutionNd(*conv33_cv2_3_1->getOutput(0), 64, nvinfer1::DimsHW{1, 1}, weightMap["model.33.cv2.3.2.weight"], weightMap["model.33.cv2.3.2.bias"]);
    conv33_cv2_3_2->setStrideNd(nvinfer1::DimsHW{1, 1});
    conv33_cv2_3_2->setPaddingNd(nvinfer1::DimsHW{0, 0});
    nvinfer1::IElementWiseLayer* conv33_cv3_3_0 = convBnSiLU(network, weightMap, *conv32->getOutput(0), base_out_channel, 3, 1, calculateP(3), "model.33.cv3.3.0");
    nvinfer1::IElementWiseLayer* conv33_cv3_3_1 = convBnSiLU(network, weightMap, *conv33_cv3_3_0->getOutput(0), base_out_channel, 3, 1, calculateP(3), "model.33.cv3.3.1");
    nvinfer1::IConvolutionLayer* conv33_cv3_3_2 = network->addConvolutionNd(*conv33_cv3_3_1->getOutput(0), kNumClass, nvinfer1::DimsHW{1, 1}, weightMap["model.33.cv3.3.2.weight"], weightMap["model.33.cv3.3.2.bias"]);
    ...
    *******************************************************************************************************/
    ...
    nvinfer1::ISliceLayer* split33_0_0 = network->addSlice( *shuffle33_0->getOutput(0), nvinfer1::Dims2{0, 0}, nvinfer1::Dims2{64, (kInputH / strides[0]) * (kInputW / strides[0])}, nvinfer1::Dims2{1, 1});
    nvinfer1::ISliceLayer* split33_0_1 = network->addSlice( *shuffle33_0->getOutput(0), nvinfer1::Dims2{64, 0}, nvinfer1::Dims2{kNumClass, (kInputH / strides[0]) * (kInputW / strides[0])}, nvinfer1::Dims2{1, 1});
    nvinfer1::IShuffleLayer* dfl33_0 = DFL(network, weightMap, *split33_0_0->getOutput(0), 4, (kInputH / strides[0]) * (kInputW / strides[0]), 1, 1, 0, "model.33.dfl.conv.weight");
    ...
    nvinfer1::ISliceLayer* split33_1_0 = network->addSlice( *shuffle33_1->getOutput(0), nvinfer1::Dims2{0, 0}, nvinfer1::Dims2{64, (kInputH / strides[1]) * (kInputW / strides[1])}, nvinfer1::Dims2{1, 1});
    nvinfer1::ISliceLayer* split33_1_1 = network->addSlice( *shuffle33_1->getOutput(0), nvinfer1::Dims2{64, 0}, nvinfer1::Dims2{kNumClass, (kInputH / strides[1]) * (kInputW / strides[1])}, nvinfer1::Dims2{1, 1});
    nvinfer1::IShuffleLayer* dfl33_1 = DFL(network, weightMap, *split33_1_0->getOutput(0), 4, (kInputH / strides[1]) * (kInputW / strides[1]), 1, 1, 0, "model.33.dfl.conv.weight");
    ...
    nvinfer1::ISliceLayer* split33_2_0 = network->addSlice( *shuffle33_2->getOutput(0), nvinfer1::Dims2{0, 0}, nvinfer1::Dims2{64, (kInputH / strides[2]) * (kInputW / strides[2])}, nvinfer1::Dims2{1, 1});
    nvinfer1::ISliceLayer* split33_2_1 = network->addSlice( *shuffle33_2->getOutput(0), nvinfer1::Dims2{64, 0}, nvinfer1::Dims2{kNumClass, (kInputH / strides[2]) * (kInputW / strides[2])}, nvinfer1::Dims2{1, 1});
    nvinfer1::IShuffleLayer* dfl33_2 = DFL(network, weightMap, *split33_2_0->getOutput(0), 4, (kInputH / strides[2]) * (kInputW / strides[2]), 1, 1, 0, "model.33.dfl.conv.weight");
    ...
    nvinfer1::ISliceLayer* split33_3_0 = network->addSlice( *shuffle33_3->getOutput(0), nvinfer1::Dims2{0, 0}, nvinfer1::Dims2{64, (kInputH / strides[3]) * (kInputW / strides[3])}, nvinfer1::Dims2{1, 1});
    nvinfer1::ISliceLayer* split33_3_1 = network->addSlice( *shuffle33_3->getOutput(0), nvinfer1::Dims2{64, 0}, nvinfer1::Dims2{kNumClass, (kInputH / strides[3]) * (kInputW / strides[3])}, nvinfer1::Dims2{1, 1});
    nvinfer1::IShuffleLayer* dfl33_3 = DFL(network, weightMap, *split33_3_0->getOutput(0), 4, (kInputH / strides[3]) * (kInputW / strides[3]), 1, 1, 0, "model.33.dfl.conv.weight");
    ...
    nvinfer1::IPluginV2Layer* yolo = addYoLoLayer(network, std::vector<nvinfer1::IConcatenationLayer*>{cat33_dfl_0, cat33_dfl_1, cat33_dfl_2, cat33_dfl_3}, strides, stridesLength, false, false);
