...
IHostMemory* build_engine_yolov7e6e(unsigned int maxBatchSize, IBuilder* builder, IBuilderConfig* config, DataType dt,
    ...
    ITensor* input_tensor_21[] = {conv20->getOutput(0), conv18->getOutput(0), conv16->getOutput(0),
                                  conv14->getOutput(0), conv13->getOutput(0)};
    ...
    ITensor* input_tensor_33[] = {conv32->getOutput(0), conv30->getOutput(0), conv28->getOutput(0),
                                  conv26->getOutput(0), conv25->getOutput(0)};
    ...
    ITensor* input_tensor_43[] = {conv42->getOutput(0), conv40->getOutput(0), conv38->getOutput(0),
                                  conv36->getOutput(0), conv35->getOutput(0)};
    ...
    ITensor* input_tensor_55[] = {conv54->getOutput(0), conv52->getOutput(0), conv50->getOutput(0),
                                  conv48->getOutput(0), conv47->getOutput(0)};
    ...
    ITensor* input_tensor_65[] = {conv64->getOutput(0), conv62->getOutput(0), conv60->getOutput(0),
                                  conv58->getOutput(0), conv57->getOutput(0)};
    ...
    ITensor* input_tensor_77[] = {conv76->getOutput(0), conv74->getOutput(0), conv72->getOutput(0),
                                  conv70->getOutput(0), conv69->getOutput(0)};
    ...
    ITensor* input_tensor_87[] = {conv86->getOutput(0), conv84->getOutput(0), conv82->getOutput(0),
                                  conv80->getOutput(0), conv79->getOutput(0)};
    ...
    ITensor* input_tensor_99[] = {conv98->getOutput(0), conv96->getOutput(0), conv94->getOutput(0),
                                  conv92->getOutput(0), conv91->getOutput(0)};
    ...
    ITensor* input_tensor_109[] = {conv108->getOutput(0), conv106->getOutput(0), conv104->getOutput(0),
                                   conv102->getOutput(0), conv101->getOutput(0)};
    ...
    ITensor* input_tensor_125[] = {conv124->getOutput(0), conv123->getOutput(0), conv122->getOutput(0),
                                   conv121->getOutput(0), conv120->getOutput(0), conv119->getOutput(0),
                                   conv118->getOutput(0), conv117->getOutput(0)};
    ...
    ITensor* input_tensor_135[] = {conv134->getOutput(0), conv133->getOutput(0), conv132->getOutput(0),
                                   conv131->getOutput(0), conv130->getOutput(0), conv129->getOutput(0),
                                   conv128->getOutput(0), conv127->getOutput(0)};
    ...
    ITensor* input_tensor_150[] = {conv149->getOutput(0), conv148->getOutput(0), conv147->getOutput(0),
                                   conv146->getOutput(0), conv145->getOutput(0), conv144->getOutput(0),
                                   conv143->getOutput(0), conv142->getOutput(0)};
    ...
    ITensor* input_tensor_160[] = {conv159->getOutput(0), conv158->getOutput(0), conv157->getOutput(0),
                                   conv156->getOutput(0), conv155->getOutput(0), conv154->getOutput(0),
                                   conv153->getOutput(0), conv152->getOutput(0)};
    ...
    ITensor* input_tensor_175[] = {conv174->getOutput(0), conv173->getOutput(0), conv172->getOutput(0),
                                   conv171->getOutput(0), conv170->getOutput(0), conv169->getOutput(0),
                                   conv168->getOutput(0), conv167->getOutput(0)};
    ...
    ITensor* input_tensor_185[] = {conv184->getOutput(0), conv183->getOutput(0), conv182->getOutput(0),
                                   conv181->getOutput(0), conv180->getOutput(0), conv179->getOutput(0),
                                   conv178->getOutput(0), conv177->getOutput(0)};
    ...
    ITensor* input_tensor_198[] = {conv197->getOutput(0), conv196->getOutput(0), conv195->getOutput(0),
                                   conv194->getOutput(0), conv193->getOutput(0), conv192->getOutput(0),
                                   conv191->getOutput(0), conv190->getOutput(0)};
    ...
    ITensor* input_tensor_208[] = {conv207->getOutput(0), conv206->getOutput(0), conv205->getOutput(0),
                                   conv204->getOutput(0), conv203->getOutput(0), conv202->getOutput(0),
                                   conv201->getOutput(0), conv200->getOutput(0)};
    ...
    ITensor* input_tensor_221[] = {conv220->getOutput(0), conv219->getOutput(0), conv218->getOutput(0),
                                   conv217->getOutput(0), conv216->getOutput(0), conv215->getOutput(0),
                                   conv214->getOutput(0), conv213->getOutput(0)};
    ...
    ITensor* input_tensor_231[] = {conv230->getOutput(0), conv229->getOutput(0), conv228->getOutput(0),
                                   conv227->getOutput(0), conv226->getOutput(0), conv225->getOutput(0),
                                   conv224->getOutput(0), conv223->getOutput(0)};
    ...
    ITensor* input_tensor_244[] = {conv243->getOutput(0), conv242->getOutput(0), conv241->getOutput(0),
                                   conv240->getOutput(0), conv239->getOutput(0), conv238->getOutput(0),
                                   conv237->getOutput(0), conv236->getOutput(0)};
    ...
    ITensor* input_tensor_254[] = {conv253->getOutput(0), conv252->getOutput(0), conv251->getOutput(0),
                                   conv250->getOutput(0), conv249->getOutput(0), conv248->getOutput(0),
                                   conv247->getOutput(0), conv246->getOutput(0)};
    ...
    // out
    IConvolutionLayer* cv105_0 =
            network->addConvolutionNd(*conv257->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.261.m.0.weight"], weightMap["model.261.m.0.bias"]);
    assert(cv105_0);
    cv105_0->setName("cv105.0");
    IConvolutionLayer* cv105_1 =
            network->addConvolutionNd(*conv258->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.261.m.1.weight"], weightMap["model.261.m.1.bias"]);
    assert(cv105_1);
    cv105_1->setName("cv105.1");
    IConvolutionLayer* cv105_2 =
            network->addConvolutionNd(*conv259->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.261.m.2.weight"], weightMap["model.261.m.2.bias"]);
    assert(cv105_2);
    cv105_2->setName("cv105.2");
    IConvolutionLayer* cv105_3 =
            network->addConvolutionNd(*conv260->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.261.m.3.weight"], weightMap["model.261.m.3.bias"]);
    assert(cv105_3);
    cv105_3->setName("cv105.3");

    /*------------detect-----------*/
    auto yolo = addYoLoLayer(network, weightMap, "model.261",
                             std::vector<IConvolutionLayer*>{cv105_0, cv105_1, cv105_2, cv105_3});
...
IHostMemory* build_engine_yolov7d6(unsigned int maxBatchSize, IBuilder* builder, IBuilderConfig* config, DataType dt,
                                   const std::string& wts_path) {
    std::map<std::string, Weights> weightMap = loadWeights(wts_path);
    ...
    ITensor* input_tensor_13[] = {conv12->getOutput(0), conv10->getOutput(0), conv8->getOutput(0),
                                  conv6->getOutput(0),  conv4->getOutput(0),  conv3->getOutput(0)};
    ...
    ITensor* input_tensor_26[] = {conv25->getOutput(0), conv23->getOutput(0), conv21->getOutput(0),
                                  conv19->getOutput(0), conv17->getOutput(0), conv16->getOutput(0)};
    ...
    ITensor* input_tensor_39[] = {conv38->getOutput(0), conv36->getOutput(0), conv34->getOutput(0),
                                  conv32->getOutput(0), conv30->getOutput(0), conv29->getOutput(0)};
    ...
    ITensor* input_tensor_52[] = {conv51->getOutput(0), conv49->getOutput(0), conv47->getOutput(0),
                                  conv45->getOutput(0), conv43->getOutput(0), conv42->getOutput(0)};
    ...
    ITensor* input_tensor_65[] = {conv64->getOutput(0), conv62->getOutput(0), conv60->getOutput(0),
                                  conv58->getOutput(0), conv56->getOutput(0), conv55->getOutput(0)};
    ...
    ITensor* input_tensor_82[] = {conv81->getOutput(0), conv80->getOutput(0), conv79->getOutput(0),
                                  conv78->getOutput(0), conv77->getOutput(0), conv76->getOutput(0),
                                  conv75->getOutput(0), conv74->getOutput(0), conv73->getOutput(0),
                                  conv72->getOutput(0)};
    ...
    ITensor* input_tensor_98[] = {conv97->getOutput(0), conv96->getOutput(0), conv95->getOutput(0),
                                  conv94->getOutput(0), conv93->getOutput(0), conv92->getOutput(0),
                                  conv91->getOutput(0), conv90->getOutput(0), conv89->getOutput(0),
                                  conv88->getOutput(0)};
    ...
    ITensor* input_tensor_114[] = {conv113->getOutput(0), conv112->getOutput(0), conv111->getOutput(0),
                                   conv110->getOutput(0), conv109->getOutput(0), conv108->getOutput(0),
                                   conv107->getOutput(0), conv106->getOutput(0), conv105->getOutput(0),
                                   conv104->getOutput(0)};
    ...
    ITensor* input_tensor_128[] = {conv127->getOutput(0), conv126->getOutput(0), conv125->getOutput(0),
                                   conv124->getOutput(0), conv123->getOutput(0), conv122->getOutput(0),
                                   conv121->getOutput(0), conv120->getOutput(0), conv119->getOutput(0),
                                   conv118->getOutput(0)};
    ...
    ITensor* input_tensor_142[] = {conv141->getOutput(0), conv140->getOutput(0), conv139->getOutput(0),
                                   conv138->getOutput(0), conv137->getOutput(0), conv136->getOutput(0),
                                   conv135->getOutput(0), conv134->getOutput(0), conv133->getOutput(0),
                                   conv132->getOutput(0)};
    ...
    ITensor* input_tensor_156[] = {conv155->getOutput(0), conv154->getOutput(0), conv153->getOutput(0),
                                   conv152->getOutput(0), conv151->getOutput(0), conv150->getOutput(0),
                                   conv149->getOutput(0), conv148->getOutput(0), conv147->getOutput(0),
                                   conv146->getOutput(0)};
    ...
    // out
    IConvolutionLayer* cv105_0 =
            network->addConvolutionNd(*conv158->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.162.m.0.weight"], weightMap["model.162.m.0.bias"]);
    assert(cv105_0);
    cv105_0->setName("cv105.0");
    IConvolutionLayer* cv105_1 =
            network->addConvolutionNd(*conv159->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.162.m.1.weight"], weightMap["model.162.m.1.bias"]);
    assert(cv105_1);
    cv105_1->setName("cv105.1");
    IConvolutionLayer* cv105_2 =
            network->addConvolutionNd(*conv160->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.162.m.2.weight"], weightMap["model.162.m.2.bias"]);
    assert(cv105_2);
    cv105_2->setName("cv105.2");
    IConvolutionLayer* cv105_3 =
            network->addConvolutionNd(*conv161->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.162.m.3.weight"], weightMap["model.162.m.3.bias"]);
    assert(cv105_3);
    cv105_3->setName("cv105.3");

    /*------------detect-----------*/
    auto yolo = addYoLoLayer(network, weightMap, "model.162",
                             std::vector<IConvolutionLayer*>{cv105_0, cv105_1, cv105_2, cv105_3});
    yolo->getOutput(0)->setName(kOutputTensorName);
    network->markOutput(*yolo->getOutput(0));
    // Build engine
...
IHostMemory* build_engine_yolov7e6(unsigned int maxBatchSize, IBuilder* builder, IBuilderConfig* config, DataType dt,
                                   const std::string& wts_path) {
    std::map<std::string, Weights> weightMap = loadWeights(wts_path);
    ...
    IElementWiseLayer* conv20 = convBnSilu(network, weightMap, *conv19->getOutput(0), 128, 3, 1, 1, "model.20");
    IElementWiseLayer* conv21 = convBnSilu(network, weightMap, *conv20->getOutput(0), 128, 3, 1, 1, "model.21");
    ITensor* input_tensor_22[] = {conv21->getOutput(0), conv19->getOutput(0), conv17->getOutput(0),
                                  conv15->getOutput(0), conv14->getOutput(0)};
    ...
    ITensor* input_tensor_44[] = {conv43->getOutput(0), conv41->getOutput(0), conv39->getOutput(0),
                                  conv37->getOutput(0), conv36->getOutput(0)};
    ...
    ITensor* input_tensor_70[] = {conv69->getOutput(0), conv68->getOutput(0), conv67->getOutput(0),
                                  conv66->getOutput(0), conv65->getOutput(0), conv64->getOutput(0),
                                  conv63->getOutput(0), conv62->getOutput(0)};
    ...
    ITensor* input_tensor_84[] = {conv83->getOutput(0), conv82->getOutput(0), conv81->getOutput(0),
                                  conv80->getOutput(0), conv79->getOutput(0), conv78->getOutput(0),
                                  conv77->getOutput(0), conv76->getOutput(0)};
    ...
    ITensor* input_tensor_98[] = {conv97->getOutput(0), conv96->getOutput(0), conv95->getOutput(0),
                                  conv94->getOutput(0), conv93->getOutput(0), conv92->getOutput(0),
                                  conv91->getOutput(0), conv90->getOutput(0)};
    ...
    ITensor* input_tensor_110[] = {conv109->getOutput(0), conv108->getOutput(0), conv107->getOutput(0),
                                   conv106->getOutput(0), conv105->getOutput(0), conv104->getOutput(0),
                                   conv103->getOutput(0), conv102->getOutput(0)};
    ...
    IElementWiseLayer* conv120 = convBnSilu(network, weightMap, *conv119->getOutput(0), 192, 3, 1, 1, "model.120");
    IElementWiseLayer* conv121 = convBnSilu(network, weightMap, *conv120->getOutput(0), 192, 3, 1, 1, "model.121");
    ITensor* input_tensor_122[] = {conv121->getOutput(0), conv120->getOutput(0), conv119->getOutput(0),
                                   conv118->getOutput(0), conv117->getOutput(0), conv116->getOutput(0),
                                   conv115->getOutput(0), conv114->getOutput(0)};
    ...
    ITensor* input_tensor_134[] = {conv133->getOutput(0), conv132->getOutput(0), conv131->getOutput(0),
                                   conv130->getOutput(0), conv129->getOutput(0), conv128->getOutput(0),
                                   conv127->getOutput(0), conv126->getOutput(0)};
    ...
    // out
    IConvolutionLayer* cv105_0 =
            network->addConvolutionNd(*conv136->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.140.m.0.weight"], weightMap["model.140.m.0.bias"]);
    assert(cv105_0);
    cv105_0->setName("cv105.0");
    IConvolutionLayer* cv105_1 =
            network->addConvolutionNd(*conv137->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.140.m.1.weight"], weightMap["model.140.m.1.bias"]);
    assert(cv105_1);
    cv105_1->setName("cv105.1");
    IConvolutionLayer* cv105_2 =
            network->addConvolutionNd(*conv138->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.140.m.2.weight"], weightMap["model.140.m.2.bias"]);
    assert(cv105_2);
    cv105_2->setName("cv105.2");
    IConvolutionLayer* cv105_3 =
            network->addConvolutionNd(*conv139->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.140.m.3.weight"], weightMap["model.140.m.3.bias"]);
    assert(cv105_3);
    cv105_3->setName("cv105.3");

    /*------------detect-----------*/
    auto yolo = addYoLoLayer(network, weightMap, "model.140",
                             std::vector<IConvolutionLayer*>{cv105_0, cv105_1, cv105_2, cv105_3});
    yolo->getOutput(0)->setName(kOutputTensorName);
    network->markOutput(*yolo->getOutput(0));
    // Build engine
...
IHostMemory* build_engine_yolov7w6(unsigned int maxBatchSize, IBuilder* builder, IBuilderConfig* config, DataType dt,
                                   const std::string& wts_path) {
    std::map<std::string, Weights> weightMap = loadWeights(wts_path);
    ...
    IElementWiseLayer* conv16 = convBnSilu(network, weightMap, *conv15->getOutput(0), 128, 3, 1, 1, "model.16");
    IElementWiseLayer* conv17 = convBnSilu(network, weightMap, *conv16->getOutput(0), 128, 3, 1, 1, "model.17");
    ITensor* input_tensor_18[] = {conv17->getOutput(0), conv15->getOutput(0), conv13->getOutput(0),
                                  conv12->getOutput(0)};
    ...
    ITensor* input_tensor_27[] = {conv26->getOutput(0), conv24->getOutput(0), conv22->getOutput(0),
                                  conv21->getOutput(0)};
    ...
    ITensor* input_tensor_36[] = {conv35->getOutput(0), conv33->getOutput(0), conv31->getOutput(0),
                                  conv30->getOutput(0)};
    ...
    ITensor* input_tensor_45[] = {conv44->getOutput(0), conv42->getOutput(0), conv40->getOutput(0),
                                  conv39->getOutput(0)};
    ...
    ITensor* input_tensor_58[] = {conv57->getOutput(0), conv56->getOutput(0), conv55->getOutput(0),
                                  conv54->getOutput(0), conv53->getOutput(0), conv52->getOutput(0)};
    ...
    ITensor* input_tensor_92[] = {conv91->getOutput(0), conv90->getOutput(0), conv89->getOutput(0),
                                  conv88->getOutput(0), conv87->getOutput(0), conv86->getOutput(0)};
    ...
    ITensor* input_tensor_102[] = {conv101->getOutput(0), conv100->getOutput(0), conv99->getOutput(0),
                                   conv98->getOutput(0),  conv97->getOutput(0),  conv96->getOutput(0)};
    ...
    ITensor* input_tensor_112[] = {conv111->getOutput(0), conv110->getOutput(0), conv109->getOutput(0),
                                   conv108->getOutput(0), conv107->getOutput(0), conv106->getOutput(0)};
    ...
    // out
    IConvolutionLayer* cv105_0 =
            network->addConvolutionNd(*conv114->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.118.m.0.weight"], weightMap["model.118.m.0.bias"]);
    assert(cv105_0);
    cv105_0->setName("cv105.0");
    IConvolutionLayer* cv105_1 =
            network->addConvolutionNd(*conv115->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.118.m.1.weight"], weightMap["model.118.m.1.bias"]);
    assert(cv105_1);
    cv105_1->setName("cv105.1");
    IConvolutionLayer* cv105_2 =
            network->addConvolutionNd(*conv116->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.118.m.2.weight"], weightMap["model.118.m.2.bias"]);
    assert(cv105_2);
    cv105_2->setName("cv105.2");
    IConvolutionLayer* cv105_3 =
            network->addConvolutionNd(*conv117->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.118.m.3.weight"], weightMap["model.118.m.3.bias"]);
    assert(cv105_3);
    cv105_3->setName("cv105.3");

    /*------------detect-----------*/
    auto yolo = addYoLoLayer(network, weightMap, "model.118",
                             std::vector<IConvolutionLayer*>{cv105_0, cv105_1, cv105_2, cv105_3});
    yolo->getOutput(0)->setName(kOutputTensorName);
    network->markOutput(*yolo->getOutput(0));
    // Build engine
...
IHostMemory* build_engine_yolov7x(unsigned int maxBatchSize, IBuilder* builder, IBuilderConfig* config, DataType dt,
                                  const std::string& wts_path) {
    std::map<std::string, Weights> weightMap = loadWeights(wts_path);
    ...
    ITensor* input_tensor_12[] = {conv11->getOutput(0), conv9->getOutput(0), conv7->getOutput(0), conv5->getOutput(0),
                                  conv4->getOutput(0)};
    ...
    ITensor* input_tensor_27[] = {conv26->getOutput(0), conv24->getOutput(0), conv22->getOutput(0),
                                  conv20->getOutput(0), conv19->getOutput(0)};
    ...
    ITensor* input_tensor_42[] = {conv41->getOutput(0), conv39->getOutput(0), conv37->getOutput(0),
                                  conv35->getOutput(0), conv34->getOutput(0)};
    ...
    ITensor* input_tensor_57[] = {conv56->getOutput(0), conv54->getOutput(0), conv52->getOutput(0),
                                  conv50->getOutput(0), conv49->getOutput(0)};
    ...
    ITensor* input_tensor_72[] = {conv71->getOutput(0), conv69->getOutput(0), conv67->getOutput(0),
                                  conv65->getOutput(0), conv64->getOutput(0)};
    ...
    ITensor* input_tensor_86[] = {conv85->getOutput(0), conv83->getOutput(0), conv81->getOutput(0),
                                  conv79->getOutput(0), conv78->getOutput(0)};
    ...
    ITensor* input_tensor_101[] = {conv100->getOutput(0), conv98->getOutput(0), conv96->getOutput(0),
                                   conv94->getOutput(0), conv93->getOutput(0)};
    ...
    ITensor* input_tensor_116[] = {conv115->getOutput(0), conv113->getOutput(0), conv111->getOutput(0),
                                   conv109->getOutput(0), conv108->getOutput(0)};
    ...
    IConvolutionLayer* det0 =
            network->addConvolutionNd(*con_0->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.121.m.0.weight"], weightMap["model.121.m.0.bias"]);
    assert(det0);
    det0->setName("det0");
    IConvolutionLayer* det1 =
            network->addConvolutionNd(*con_1->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.121.m.1.weight"], weightMap["model.121.m.1.bias"]);
    assert(det1);
    det1->setName("det1");
    IConvolutionLayer* det2 =
            network->addConvolutionNd(*con_2->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.121.m.2.weight"], weightMap["model.121.m.2.bias"]);
    assert(det2);
    det2->setName("det2");
...
IHostMemory* build_engine_yolov7(unsigned int maxBatchSize, IBuilder* builder, IBuilderConfig* config, DataType dt,
                                 const std::string& wts_path) {
    std::map<std::string, Weights> weightMap = loadWeights(wts_path);
    ...
    IElementWiseLayer* conv21 = convBnSilu(network, weightMap, *conv20->getOutput(0), 128, 3, 1, 1, "model.21");
    IElementWiseLayer* conv22 = convBnSilu(network, weightMap, *conv21->getOutput(0), 128, 3, 1, 1, "model.22");
    ITensor* input_tensor_23[] = {conv22->getOutput(0), conv20->getOutput(0), conv18->getOutput(0),
                                  conv17->getOutput(0)};
    ...
    ITensor* input_tensor_49[] = {conv48->getOutput(0), conv46->getOutput(0), conv44->getOutput(0),
                                  conv43->getOutput(0)};
    ...
    ITensor* input_tensor_62[] = {conv61->getOutput(0), conv60->getOutput(0), conv59->getOutput(0),
                                  conv58->getOutput(0), conv57->getOutput(0), conv56->getOutput(0)};
    ...
    ITensor* input_tensor_74[] = {conv73->getOutput(0), conv72->getOutput(0), conv71->getOutput(0),
                                  conv70->getOutput(0), conv69->getOutput(0), conv68->getOutput(0)};
    ...
    ITensor* input_tensor_87[] = {conv86->getOutput(0), conv85->getOutput(0), conv84->getOutput(0),
                                  conv83->getOutput(0), conv82->getOutput(0), conv81->getOutput(0)};
    ...
    IElementWiseLayer* conv98 = convBnSilu(network, weightMap, *conv97->getOutput(0), 256, 3, 1, 1, "model.98");
    IElementWiseLayer* conv99 = convBnSilu(network, weightMap, *conv98->getOutput(0), 256, 3, 1, 1, "model.99");
    ITensor* input_tensor_100[] = {conv99->getOutput(0), conv98->getOutput(0), conv97->getOutput(0),
                                   conv96->getOutput(0), conv95->getOutput(0), conv94->getOutput(0)};
    ...
    /*----------------------------------yolov7 out-----------------------------------------*/
    IConvolutionLayer* cv105_0 =
            network->addConvolutionNd(*conv102->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.105.m.0.weight"], weightMap["model.105.m.0.bias"]);
    assert(cv105_0);
    cv105_0->setName("cv105.0");
    IConvolutionLayer* cv105_1 =
            network->addConvolutionNd(*conv103->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.105.m.1.weight"], weightMap["model.105.m.1.bias"]);
    assert(cv105_1);
    cv105_1->setName("cv105.1");
    IConvolutionLayer* cv105_2 =
            network->addConvolutionNd(*conv104->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.105.m.2.weight"], weightMap["model.105.m.2.bias"]);
    assert(cv105_2);
    cv105_2->setName("cv105.2");

    auto yolo =
            addYoLoLayer(network, weightMap, "model.105", std::vector<IConvolutionLayer*>{cv105_0, cv105_1, cv105_2});
    yolo->getOutput(0)->setName(kOutputTensorName);
    network->markOutput(*yolo->getOutput(0));
...
IHostMemory* build_engine_yolov7_tiny(unsigned int maxBatchSize, IBuilder* builder, IBuilderConfig* config, DataType dt,
                                      std::string& wts_name) {
    INetworkDefinition* network = builder->createNetworkV2(0U);
    ...
    ITensor* input_tensor_13[] = {conv12->getOutput(0), conv11->getOutput(0), conv10->getOutput(0),
                                  conv9->getOutput(0)};
    ...
    ITensor* input_tensor_20[] = {conv19->getOutput(0), conv18->getOutput(0), conv17->getOutput(0),
                                  conv16->getOutput(0)};
    ...
    ITensor* input_tensor_27[] = {conv26->getOutput(0), conv25->getOutput(0), conv24->getOutput(0),
                                  conv23->getOutput(0)};
    ...
    ITensor* input_tensor_34[] = {pool33->getOutput(0), pool32->getOutput(0), pool31->getOutput(0),
                                  conv30->getOutput(0)};
    ...
    ITensor* input_tensor_46[] = {conv45->getOutput(0), conv44->getOutput(0), conv43->getOutput(0),
                                  conv42->getOutput(0)};
    ...
    ITensor* input_tensor_56[] = {conv55->getOutput(0), conv54->getOutput(0), conv53->getOutput(0),
                                  conv52->getOutput(0)};
    ...
    ITensor* input_tensor_64[] = {conv63->getOutput(0), conv62->getOutput(0), conv61->getOutput(0),
                                  conv60->getOutput(0)};
    ...
    ITensor* input_tensor_72[] = {conv71->getOutput(0), conv70->getOutput(0), conv69->getOutput(0),
                                  conv68->getOutput(0)};
    ...
    /* ------ detect ------ */
    IConvolutionLayer* det0 =
            network->addConvolutionNd(*conv74->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.77.m.0.weight"], weightMap["model.77.m.0.bias"]);

    IConvolutionLayer* det1 =
            network->addConvolutionNd(*conv75->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.77.m.1.weight"], weightMap["model.77.m.1.bias"]);

    IConvolutionLayer* det2 =
            network->addConvolutionNd(*conv76->getOutput(0), kNumAnchor * (kNumClass + 5), DimsHW{1, 1},
                                      weightMap["model.77.m.2.weight"], weightMap["model.77.m.2.bias"]);
