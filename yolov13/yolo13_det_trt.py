...
class inferThread(threading.Thread):
    ...
    def run(self):
        batch_image_raw, use_time = self.yolov13_wrapper.infer(self.yolov13_wrapper.get_raw_image(self.image_path_batch))
...
if __name__ == "__main__":
    ...
    PLUGIN_LIBRARY = "E:\\tensorrtx-master\\yolov13\\debug\\Debug\\myplugins.dll"
    engine_file_path = "E:\\tensorrtx-master\\yolov13\\debug\\Debug\\yolov13x-det.engine"
    ...
    try:
        ...
        image_dir = "E:\\tensorrtx-master\\yolov13\images-2"
